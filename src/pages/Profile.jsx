        ...
        <section className="users-description">
          ...
          <p
            ...
            onClick={(e) => {
              ...
              // @ts-ignore
              document.querySelector("#aboutMe-profile-desc").style.display =
                "block";
              // @ts-ignore
          ...
          <p
            onClick={(e) => {
              ...
              e.target.style.display = "none";
              // @ts-ignore
              document.querySelector("#likes-profile-desc").style.display =
                "block";
              // @ts-ignore
          ...
          <p
            onClick={(e) => {
              ...
              e.target.style.display = "none";
              // @ts-ignore
              document.querySelector("#dislikes-profile-desc").style.display =
                "block";
              // @ts-ignore
