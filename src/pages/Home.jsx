...
const Home = () => {
   ...
   useEffect(() => {
      allUsers.length === 0 &&
         currentUser &&
         fetchUsers(currentUser.interestedIn).then((users) =>
            setAllUsers(shuffle(users))
         );
   }, [currentUser]);
   ...
   return (
      <main className='home'>
         ...
         <section className='home-btns'>
            ...
            >
               <img className='onclick-btn' src='/x.svg' alt='' />
            </HomeBtn>
            ...
            <HomeBtn
               ...
               disabled={0 === usersToDisplay.length || isMatch}
            >
               <img className='onclick-btn' src='/heart.svg' alt='' />
            </HomeBtn>
